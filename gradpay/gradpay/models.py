...
class Survey(models.Model):
    ...
    email = models.EmailField(
        ...
        help_text='Note: You must use an academic [.edu] email address.',
    )
    ...
    degree = models.ManyToManyField(
        Degree,
        help_text='Which degree(s) are you pursuing? Check all that apply.',
    )
    start_year = models.IntegerField(help_text='Year you began your program [yyyy].')
    graduation_year = models.IntegerField(
        help_text='Year of (expected) graduation [yyyy].',
    )
    ...
    teaching_terms = models.PositiveIntegerField(
        help_text=(
            'Total number of terms you expect to work as a teaching assistant '
            'or instructor.'
        )
    )
    ...
    part_time_work = models.CharField(
        ...
        help_text=(
            'Have you or do you plan to work at a part-time job during your graduate '
            'program (not including teaching or research assistantships)?'
        )
    )
    student_loans = models.CharField(
        ...
        help_text=(
            'Have you or do you plan to take out student loans <strong>during your '
            'graduate program</strong>? Do not include loans taken out before graduate '
            'school.'
        )
    )
    ...
    leave = models.CharField(
        ...
        help_text=(
            "Are you eligible for family and/or medical leave (e.g., leave for illness, "
            "a family member's illness, or childbirth)?"
        ),
    )
    ...
    career = models.CharField(
        max_length=16,
        help_text=(
            'Which of the following best describes your desired career after you '
